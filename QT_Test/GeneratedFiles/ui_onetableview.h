/********************************************************************************
** Form generated from reading UI file 'onetableview.ui'
**
...
#ifndef UI_ONETABLEVIEW_H
#define UI_ONETABLEVIEW_H
...
public:
    ...
    void setupUi(QWidget *oneTableView)
    {
        if (oneTableView->objectName().isEmpty())
            oneTableView->setObjectName(QStringLiteral("oneTableView"));
        oneTableView->resize(719, 478);
        labe_top = new QLabel(oneTableView);
        labe_top->setObjectName(QStringLiteral("labe_top"));
        labe_top->setGeometry(QRect(0, 0, 721, 40));
        QPalette palette;
        ...
        labe_top->setPalette(palette);
        labe_top->setAutoFillBackground(true);
        labe_bot = new QLabel(oneTableView);
        labe_bot->setObjectName(QStringLiteral("labe_bot"));
        labe_bot->setGeometry(QRect(0, 460, 721, 20));
        QPalette palette1;
        ...
        labe_bot->setPalette(palette1);
        labe_bot->setAutoFillBackground(true);
        labe_left = new QLabel(oneTableView);
        labe_left->setObjectName(QStringLiteral("labe_left"));
        labe_left->setGeometry(QRect(0, 10, 20, 451));
        QPalette palette2;
        ...
        labe_left->setPalette(palette2);
        labe_left->setAutoFillBackground(true);
        labe_right = new QLabel(oneTableView);
        labe_right->setObjectName(QStringLiteral("labe_right"));
        labe_right->setGeometry(QRect(700, 10, 20, 451));
        QPalette palette3;
        ...
        labe_right->setPalette(palette3);
        labe_right->setAutoFillBackground(true);
        tableWidget = new QTableWidget(oneTableView);
        tableWidget->setObjectName(QStringLiteral("tableWidget"));
        tableWidget->setGeometry(QRect(20, 40, 681, 421));
        ExitButton = new QPushButton(oneTableView);
        ExitButton->setObjectName(QStringLiteral("ExitButton"));
        ExitButton->setGeometry(QRect(680, 0, 40, 40));
        QIcon icon;
        icon.addFile(QStringLiteral("image/NO.png"), QSize(), QIcon::Normal, QIcon::Off);
        ExitButton->setIcon(icon);
        ExitButton->setIconSize(QSize(30, 30));
        ExitButton->setCheckable(false);

        retranslateUi(oneTableView);

        QMetaObject::connectSlotsByName(oneTableView);
    } // setupUi

    void retranslateUi(QWidget *oneTableView)
    {
        oneTableView->setWindowTitle(QApplication::translate("oneTableView", "Form", 0));
        labe_top->setText(QString());
        labe_bot->setText(QString());
        labe_left->setText(QString());
        labe_right->setText(QString());
...
namespace Ui {
    class oneTableView: public Ui_oneTableView {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ONETABLEVIEW_H
